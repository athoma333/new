...
public class ScheduledFlightController {
	...
	public ResponseEntity<ScheduledFlight> addSF(@RequestBody ScheduledFlight scheduledFlight,
		...
		ResponseEntity<Airport> srcAirport = restTemplate.exchange("http://localhost:9090/airport/viewAirport/"+source, HttpMethod.GET,entity,Airport.class);
		ResponseEntity<Airport> destAirport = restTemplate.exchange("http://localhost:9090/airport/viewAirport/"+destination, HttpMethod.GET,entity,Airport.class);
		BigInteger sfId = scheduledFlight.getScheduleFlightId();
		ResponseEntity<Flight> flight = restTemplate.exchange("http://localhost:9090/api/v1.0/flight/viewFlight/"+sfId, HttpMethod.GET,entity,Flight.class);
		try {
